	...
	<div class="card">
		<div class="row">
			<div class="col-sm-12 col-md-6">
				<div class="dochh">Реєстраційний номер:</div>
				<div class="dochv" data-var="reg_number"></div>
			</div>
			<div class="col-sm-12 col-md-6">
				<div class="dochh">Дата реєстрації:</div>
				<div class="dochv" data-var="reg_date"></div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12 col-md-6">
